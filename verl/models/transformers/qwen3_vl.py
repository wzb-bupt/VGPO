...
def qwen3_vl_base_forward(
    ...
    **kwargs,
    ...
    # Preserve hidden_states if output_hidden_states=True was passed
    output_kwargs = {"last_hidden_state": outputs.last_hidden_state}
    if hasattr(outputs, 'hidden_states') and outputs.hidden_states is not None:
        output_kwargs["hidden_states"] = outputs.hidden_states
    if hasattr(outputs, 'past_key_values'):
        output_kwargs["past_key_values"] = outputs.past_key_values

    return Qwen3VLModelOutputWithPast(**output_kwargs)
...
def qwen3_vl_model_forward(
    ...
    **kwargs,
    ...
    # Preserve hidden_states if output_hidden_states=True was passed
    output_kwargs = {"logits": logits}
    if hasattr(outputs, 'hidden_states') and outputs.hidden_states is not None:
        output_kwargs["hidden_states"] = outputs.hidden_states
    if hasattr(outputs, 'past_key_values'):
        output_kwargs["past_key_values"] = outputs.past_key_values

    return Qwen3VLCausalLMOutputWithPast(**output_kwargs)
